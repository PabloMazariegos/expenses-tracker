...
export default function AIFunctions() {
	return (
		<section className="w-full py-12 md:py-24 lg:py-32 flex flex-col items-center justify-center text-center gap-6 bg-gradient-to-b from-primary-50 to-black">
